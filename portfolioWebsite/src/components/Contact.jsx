  ...
  return (
    <section id="contact" className="section">
        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col lg:justify-center lg:items-start">
                <h2 className="headline-2 lg:max-w-[12ch]">
                    Get in Touch
                </h2>
                <p className="text-zinc-400 mt-4 mb-8 lg:mb-12">
                    Interested in collaborating or have a project in mind ? Feel free to reach out through any of the platforms below. I look forward to connecting with you !
                </p>
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({ href, icon, alt }, key) => (
                        <a
                            ...
                            className="w-12 h-12 grid place-items-center ring-inset ring-2 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-900"
                        >
                            {icon}
                        </a>
                    ))}
            ...
            <form action="https://getform.io/f/bdrgdevb" method="POST" className="xl:pl-10 2xl:pl-20  ">
                
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2 ">
                        <div className="mb-3">
                        <label htmlFor="name" className="label">Name</label>
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Md Muntasir Azad" className="text-field" />
                        </div>
                    </div>

                    <div className="mb-3">
                        <label htmlFor="email" className="label">Email</label>
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="mdmuntasirazad@gmail.com" className="text-field" />
                    </div>

                    <div className="mb-3">
                        <label htmlFor="message" className="label">Message</label>
                        <textarea name="message" id="message" rows="5" required placeholder="Your message here..." className="text-field resize-y min-h-32 max-h-80" />
                    </div>
